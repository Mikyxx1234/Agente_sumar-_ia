...
export function matriculaViaConsultorInstruction(args = {}) {
  ...
  lines.push(
    'INSTRUÇÃO: o sistema ativará o salesbot Kommo Formulario_Sum (formulário no WhatsApp). Peça ao lead para preencher — após o retorno o salesbot 49815 é disparado automaticamente.',
