...
export function matriculaViaConsultorInstruction(args = {}) {
  ...
  lines.push(
    'INSTRUÇÃO: o sistema ativará o salesbot Kommo Formulario_Sum (formulário no WhatsApp). Após o preenchimento: distribuição do lead, validação dos dados e salesbot 49813 (matrícula).',
